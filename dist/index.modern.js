import React__default, { createElement, Fragment, Component, useContext, useEffect } from 'react';
...
var useSip = function useSip() {
  var ctx = useContext(SIPContext);
  return ctx;
};

export { SIPProvider, phoneStore, useSip };
